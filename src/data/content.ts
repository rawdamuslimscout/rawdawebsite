...
export const scoutStages: ScoutStage[] = [
  {
    ...
    ageRange: "من ٧ إلى ١١ سنة",
    description:
      "البداية الممتعة في الرحلة الكشفية: يتعلم الطفل النظافة والاعتماد على النفس والعمل مع السداسي من خلال اللعب والحكاية والممارسة.",
    icon: "sprout",
    leaders: [],
  },
  {
    id: "kashafa-morshedat",
    title: "الكشافة والمرشدات",
    ageRange: "من ١٢ إلى ١٦ سنة",
    icon: "compass",
    description:
      "مرحلة بناء الشخصية والمهارة: يتدرّب الفتى والفتاة على الحياة في الخلاء، القيادة، الإسعافات الأولية، خدمة المجتمع والعمل ضمن الطليعة.",
    leaders: [],
  },
  {
    id: "jawwala-dalilat",
    title: "الجوّالة والدليلات",
    ageRange: "من ١٧ إلى ٢٤ سنة",
    description:
      "مرحلة المبادرة والخدمة العامة: يخطط الجوال والدليلة للمشاريع، ويتحمّل المسؤولية، ويطوّر مهاراته القيادية والمهنية لخدمة الوطن والمجتمع.",
    icon: "mountain",
    leaders: [],
  },
];
...
export const activities: Activity[] = [
  {
    ...
    title: "مخيمات",
    description:
      "مخيمات صيفية وشتوية تجمع الفرق في الطبيعة لعيش تجربة كشفية كاملة.",
    icon: "tent",
  },
  {
    id: "trips",
    title: "رحلات",
    description: "رحلات استكشافية إلى الجبال والغابات ومسارات المشي الطويلة.",
    icon: "map",
  },
  {
    id: "training",
    title: "تدريبات",
    description:
      "تدريبات ميدانية على المهارات الكشفية والقيادية على مدار السنة.",
    icon: "dumbbell",
  },
  {
    id: "service",
    title: "خدمة المجتمع",
    description: "مبادرات تطوعية وخدمية لخدمة الحي والمدينة والمجتمع المحلي.",
    icon: "handHeart",
  },
  {
    id: "competitions",
    title: "مسابقات",
    description: "مسابقات بين الفرق تختبر المهارة والروح الجماعية والريادة.",
    icon: "trophy",
  },
  {
    id: "educational",
    title: "أنشطة تربوية",
    description: "ورشات ونقاشات تنمّي القيم والمعرفة لدى الأشبال والكشافة.",
    icon: "graduationCap",
  },
  {
    id: "ramadan",
    title: "مبادرات رمضانية",
    description: "أنشطة وتمر ومي وإفطارات جماعية خلال شهر رمضان المبارك.",
    icon: "moonStar",
  },
  {
    id: "bonfire",
    title: "سهرات ونيران",
    description: "سهرات كشفية حول النار تجمع الفرق على الأناشيد والحكايا.",
    icon: "flame",
  },
];
...
export const events: EventItem[] = [
  {
    ...
    description:
      "شاركونا مخيم فوج روضة الفيحاء، وخوضوا معنا تجربة كشفية مليئة بالحماس والمغامرة.",
  },
  {
    id: "rowaysat",
    title: "رويسات صوفر",
    ...
    group: "فرقة المتقدم",
    description:
      "رحلة تحدٍّ جبلية لفرقة المتقدم ضمن سلسلة رحلات الصعود السنوية.",
  },
  {
    id: "seir-al-dinniyeh",
    title: "سير الضنية",
    ...
    description:
      "مسيرة ميدانية للأشبال والزهرات في أجواء طبيعية بين الوديان والتلال.",
  },
];
...
export const camps: CampItem[] = [
  {
    id: "c1",
    title: "مخيم الفوج الصيفي",
    year: "٢٠٢٦",
    location: "بشعزين",
    summary: "مخيم الفوج السنوي بمشاركة جميع الفرق الكشفية.",
  },
  {
    id: "c2",
    title: "مبيت الأشبال",
    year: "٢٠٢٦",
    location: "مركز الفوج",
    summary: "ليلة تخييم داخلية للأشبال بأجواء من الألعاب والسهرات.",
  },
  {
    id: "c3",
    title: "مبيت المرشدات",
    year: "٢٠٢٦",
    location: "مركز الفوج",
    summary: "مبيت كشفي لفرقة المرشدات يجمع المهارات والصداقة.",
  },
  {
    id: "c4",
    title: "رحلة درب المسيلحة",
    year: "٢٠٢٦",
    location: "المسيلحة",
    summary: "رحلة سير على الأقدام عبر الطبيعة الساحلية الشمالية.",
  },
];
...
export const news: NewsItem[] = [
  {
    ...
    date: "أيلول ٢٠٢٦",
    excerpt:
      "نشاط جماعي جمع فرقة الزهرات في أجواء من الألعاب والأناشيد الكشفية.",
  },
  {
    id: "n2",
    ...
    date: "آب ٢٠٢٦",
    excerpt:
      "سير على الأقدام عبر الساحل الشمالي في تجربة تجمع المغامرة والصداقة.",
  },
  {
    id: "n3",
...
export const galleryItems: GalleryItem[] = [
  {
    id: "g1",
    title: "خيمة المخيم بين الصنوبر",
    category: "camps",
    size: "large",
  },
  {
    id: "g2",
    title: "رايات الفوج عند شروق الشمس",
    category: "events",
    size: "medium",
  },
  ...
  {
    id: "g6",
    title: "شارات وأوسمة الفوج",
    category: "activities",
    size: "small",
  },
  {
    id: "g7",
    title: "ساحة التجمّع الصباحي",
    category: "events",
    size: "medium",
  },
...
export const blogPosts: BlogPost[] = [
  {
    ...
    author: "قيادة الفوج",
    excerpt:
      "كيف تتحوّل مرحلة الجوّالة من تنفيذ التعليمات إلى بناء المبادرة الذاتية والمسؤولية الجماعية.",
    content: [
  ...
  },
  {
    ...
    author: "فرقة المتقدم",
    excerpt:
      "مبدأ كشفي أساسي: غادر الموقع أنظف مما وجدته. كيف نطبّق هذا القول في مخيمات الفوج؟",
    content: [
  ...
  },
  {
    ...
    author: "قيادة الفوج",
    excerpt:
      "كيف تتحول أنشطة الفوج خلال رمضان إلى مزيج من العبادة الفردية والعمل الجماعي الخدمي.",
    content: [
  ...
  },
  {
    ...
    author: "قيادة الفوج",
    excerpt:
      "نبذة عن نشأة جمعية الكشاف المسلم في لبنان، من فكرة بادن باول العالمية إلى أول فرقة كشفية في بيروت.",
    content: [
...
export const joinPricing: JoinPricingTier[] = [
  {
    ...
    period: "سنويًا",
    description:
      "يشمل العضوية في الفوج، القميص الكشفي، والمشاركة في الأنشطة الأسبوعية العادية.",
  },
  {
    id: "camp",
    title: "مخيم الفوج",
    ...
    period: "لكل مخيم",
    description:
      "يشمل الإقامة والطعام والنقل خلال أيام المخيم؛ يُعلن عن كل مخيم بتفاصيله على حدة.",
  },
  {
    id: "family",
    ...
    period: "سنويًا",
    description:
      "تخفيض للعائلات التي تنتسب بأكثر من طفل إلى الفوج في نفس السنة الكشفية.",
  },
];
...
export const joinSchedule: JoinScheduleGroup[] = [
  {
    ...
    day: "السبت",
    time: "٣:٠٠ – ٤:٣٠ م",
    location: "مركز الفوج — طرابلس",
    leaders: 2,
  },
  {
    id: "js2",
    stage: "الأشبال والزهرات",
    ageRange: "٩ – ١١ سنة",
    day: "السبت",
    time: "٣:٠٠ – ٥:٠٠ م",
    location: "مركز الفوج — طرابلس",
...
export const libraryResources: LibraryResource[] = [
  ...
  },
  {
    ...
    category: "guides",
    description:
      "مرجع للقادة الجدد حول تنظيم الاجتماعات الأسبوعية وبرامج الفرق.",
    fileType: "PDF",
