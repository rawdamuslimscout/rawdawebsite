    ...
    <section className="bg-white py-24">
      <div className="mx-auto max-w-4xl px-5 sm:px-8">
        <SectionHeading
          ...
          subtitle="بيانات نموذجية للعرض — قابلة للاستبدال بالتاريخ الرسمي للفوج."
          align="center"
        />
        ...
        <ol className="relative mt-16 border-e-2 border-brand-purple/15 pe-8">
          {milestones.map((m) => (
            <li key={m.year} className="relative mb-12 last:mb-0">
              ...
              <p className="font-display text-2xl font-bold text-brand-purple">{m.year}</p>
              <h3 className="mt-1 text-lg font-semibold text-brand-ink">{m.title}</h3>
